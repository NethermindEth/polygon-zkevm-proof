...
contract PoseidonHash {
    ...
    uint256 constant PRIME = 18446744069414584321;
    ...
    function pow7(uint256 a) internal pure returns (uint256) {
        uint256 s1 = mulmod(a, a, PRIME); // s1 = a^2
        uint256 s2 = mulmod(a, s1, PRIME); // s2 = a^3
        uint256 s3 = mulmod(s2, s2, PRIME); // s3 = a^6
        uint256 result = mulmod(a, s3, PRIME); // result = a^7
        return result;
    }
